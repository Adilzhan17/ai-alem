        ...
        <RechartsPrimitive.Tooltip
            ...
            content={
                typeof content === "function" ||
                    (React.isValidElement(content) && !content.props.indicator) ? (
                    content
                ) : (
                    <ChartTooltipContent
                        indicator="dot"
...
function ChartLegend({ payload, verticalAlign = "bottom", content }: any) {
    const { config } = useChart();

    // If content is a function or react element that isn't the default component, render it
    if (
        typeof content === "function" ||
        (React.isValidElement(content) && content.type !== ChartLegendContent)
    ) {
        // If it's a function, call it with payload
        if (typeof content === "function") {
            return content({ payload, config, verticalAlign });
        }
        // If content is a React Element, clone it and pass props
