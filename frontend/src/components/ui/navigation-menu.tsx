...
function NavigationMenuLink({
    ...
    return (
        <NavigationMenuPrimitive.Link
            ...
            className={cn(
                "hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground data-[active]:bg-accent/50 data-[state=open]:bg-accent/50 flex flex-col gap-2 rounded-md p-3 text-sm transition-colors outline-none",
                className,
            )}
            {...props}
        />
